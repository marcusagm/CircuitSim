...
document.addEventListener('DOMContentLoaded', () => {
    ...
    toolManager.addTool('microcontroller', new ComponentTool(canvas, drawingManager, Microcontroller, 'Microcontrolador'));
    toolManager.addTool('logicGate', new ComponentTool(canvas, drawingManager, LogicGate, 'Porta Lógica'));
    toolManager.addTool('connector', new ComponentTool(canvas, drawingManager, Connector, 'Conector'));
    toolManager.addTool('graphic', new ComponentTool(canvas, drawingManager, Graphic, 'Gráfico'));
    toolManager.addTool('generalControl', new ComponentTool(canvas, drawingManager, GeneralControl, 'Controle Geral'));
    ...
    createToolButton('rotate', 'Rotacionar 90°', () => rotateFlipTool.rotateSelected(90));
