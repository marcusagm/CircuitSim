# 🧩 Contributing to WireToucan

Thank you for your interest in contributing to **WireToucan**!  
...
**WireToucan** is an open-source, browser-based circuit simulator focused on:
...
Contributing to **WireToucan** means upholding the principles of:
...
> Thank you for helping make WireToucan a tool that empowers the next generation of makers and engineers!

---

🧡 _Marcus Maia_  
Creator & Maintainer — [WireToucan](https://github.com/marcusagm/WireToucan)
